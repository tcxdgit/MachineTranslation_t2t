...
class TranslateZhenAi(translate.TranslateProblem):
    """Problem spec for Zh-En translation."""
    ...
    def source_vocab_name(self):
        return "vocab.zhen-ai-zh.%d" % self.approx_vocab_size

    @property
    def target_vocab_name(self):
        return "vocab.zhen-ai-en.%d" % self.approx_vocab_size
    ...
    def generate_encoded_samples(self, data_dir, tmp_dir, dataset_split):
        ...
        filename_base = "ai_zhen_%sk_tok_%s" % (self.approx_vocab_size, tag)
